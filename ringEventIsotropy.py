...
for mass in dFrames:
    ...
    filteredFrame = filteredFrame.Define("ringPT", "double ringPT[" + str(numBins) + "]; for (int i=0; i<nTracks; i++) { phiBin=static_cast<int>(" + str(numBins) + "*Tracks[i]/(2*pi); ringPT[phiBin]+=Tracks[i].phi; return ringPT}")
